...
public enum Status {
    ...
    CREATE_CONNECTION_DEFINITION_ERROR(1501000, "create process definition error", "创建连接错误"),
    CONNECTION_DEFINITION_NAME_EXIST(1501001, "connection definition name {0} already exists", "连接定义名称[{0}]已存在"),
