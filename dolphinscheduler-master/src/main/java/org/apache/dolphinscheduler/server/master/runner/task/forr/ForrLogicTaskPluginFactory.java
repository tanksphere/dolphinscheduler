...
@Slf4j
@Component
public class ForrLogicTaskPluginFactory implements ILogicTaskPluginFactory<ForrLogicTask> {
    ...
    @Override
    public ForrLogicTask createLogicTask(TaskExecutionContext taskExecutionContext) {
        return new ForrLogicTask(taskExecutionContext, processInstanceDao, taskInstanceDao, subWorkflowService,
                processService,
    ...
    public String getTaskType() {
        return ForrLogicTask.TASK_TYPE;
    }
}
