...
const defaultValue: ICreateConnectionDefaultValue = () => ({
    id: -1,
    name: '',
    url: '',
    httpHeader: [
    ...
    httpBody: {
        "bannerType": "KFHY_GRZX_JKFW",
        "enableTime" : "2022-08-23 22:00:00",
        "failureTime": "2023-02-14 22:00:00"
    },
    httpCheckCondition: '',
    description: '',
    envList: [
